...
-- AddForeignKey
ALTER TABLE "public"."Booking" ADD CONSTRAINT "Booking_servicesId_fkey" FOREIGN KEY ("servicesId") REFERENCES "public"."BarbershopService"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
